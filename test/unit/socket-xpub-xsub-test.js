    ...
    describe(`socket with ${proto} xpub/xsub`, function () {
        ...
        describe("send/receive", function () {
            it("should deliver messages", async function () {
                /* PUB  -> foo ->  XSUB -> XPUB -> SUB
                        ...
                        -> qux ->
                 */
                const address1 = (0, helpers_1.uniqAddress)(proto);
                const address2 = (0, helpers_1.uniqAddress)(proto);
        ...
        describe("verbosity", function () {
            it("should deduplicate subscriptions/unsubscriptions", async function () {
                ...
                chai_1.assert.sameDeepMembers(subs, [Buffer.from("\x01fo")]);
                sub2.close();
            });
            it("should forward all subscriptions", async function () {
                ...
                await Promise.all([subscribe(), forward()]);
                chai_1.assert.sameDeepMembers(subs, [
                    Buffer.from("\x01fo"),
                    Buffer.from("\x01fo"),
                ]);
                sub2.close();
...
//# sourceMappingURL=socket-xpub-xsub-test.js.map